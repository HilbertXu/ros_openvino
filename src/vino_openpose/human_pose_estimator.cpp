...
HumanPoseEstimator::HumanPoseEstimator()
    ...
    std::cout << "[HumanPoseEstimator] Waiting for loading model..." << std::endl;
    
}
void HumanPoseEstimator::initializeAll(const std::string& modelPath, const std::string& targetDeviceName_, bool enablePerformanceReport) {

    HumanPoseEstimator::modelPath = modelPath;
    HumanPoseEstimator::targetDeviceName = targetDeviceName_;
    HumanPoseEstimator::enablePerformanceReport = enablePerformanceReport;

    std::cout << "[HumanPoseEstimator] Load model from: " << modelPath << std::endl;
