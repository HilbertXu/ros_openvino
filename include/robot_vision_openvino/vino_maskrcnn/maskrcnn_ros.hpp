/* 
 *  Image semantic segmentation, maskrcnn_ros.hpp
...
namespace semantic_segmentation_maskrcnn {
  ...
  public:
    /*!
		* Constructor
		*/
		explicit MaskrcnnROS(ros::NodeHandle nh);
  ...
  private:
		...
		*/
		...
		//! Maskrcnn running on thread
		std::thread MaskrcnnThread_;
